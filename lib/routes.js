...
FlowRouter.route('/team_test_bay_screen', {
    name: 'team_test_bay_screen',
    action() {
        BlazeLayout.render('team_test_bay_screen')
    }
});

FlowRouter.route('/messageBoard', {
    name: 'messageBoard',
    action() {
        BlazeLayout.render('messageBoard')
    }
});

FlowRouter.route('/partsOnOrder', {
    name: 'partsOnOrder',
    action() {
        BlazeLayout.render('partsOnOrder')
    }
});

FlowRouter.route('/orderPick', {
    name: 'orderPick',
    action() {
        BlazeLayout.render('orderPick')
    }
});

FlowRouter.route('/order_analysis', {
    name: 'order_analysis',
    action() {
        BlazeLayout.render('order_analysis')
    }
});
