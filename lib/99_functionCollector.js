...
export function drawMachineInBay(canvasId) {
    try {
        ...
        if (result.bayArray.length === 0) {
          //  console.log(canvasId, canvas, result.bayArray.length )
          ...
          //  console.log('second ', canvasId, canvas, result )
   ...
   // console.log(result, canvasId)
    try {
        if (result.bayArray.length === 0) {
            ...
            console.log('2 machines detected', machineOne, machineTwo)
...
export function invokeMoveMachine(oldCanvasId, newCanvasId) {
    ...
    try {
      ...
      //  console.log(oldBay.bayArray.length, nextBay)
        // load space in new Bay and how many machines are there already
        if (oldBay.bayArray.length === 0) {
            // nothing in old bay, nothing to move
         //   console.log('error detected', oldBay.bayArray)
        ...
        if (oldMachineCount === 0 || oldMachineCount === 1) {0
            boolean = false
